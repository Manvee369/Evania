    ...
    <ScrollView contentContainerStyle={{ padding: 16, gap: 16, backgroundColor: theme.background }}>
      ...
      <View style={[styles.card, shadow.card, { backgroundColor: theme.surface }]}>
        ...
        <View style={{ flexDirection: "row", gap: 8, marginTop: 12 }}>
          <View style={[styles.chip, { backgroundColor: theme.streak }]}>
            <Text>Daily</Text>
          </View>
          <View style={[styles.chip, { backgroundColor: theme.reward }]}>
            <Text>+5 XP</Text>
          </View>
        </View>
      </View>
      ...
      <View style={{ flexDirection: "row", gap: 12 }}>
        ...
        <TouchableOpacity style={[styles.btn, { backgroundColor: theme.accent }]}>
          <Text style={styles.btnText}>Accent</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.btn, { backgroundColor: theme.success }]}>
          <Text style={{ color: theme.text }}>Soft</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={[styles.card, shadow.card, { backgroundColor: theme.surface }]}>
        ...
        <Text style={{ marginTop: 8, color: theme.text, opacity: 0.8 }}>
          Streak: <Text style={{ fontWeight: "700" }}>4 days</Text>
        </Text>
      </View>
    </ScrollView>
  );
